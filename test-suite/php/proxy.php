...
// NOTE: MODIFIED and HEAVILY SIMPLIFIED (cut to support native mode only)
//      AKa 17-Nov-2010
...
if ( !$url ) {
  ...
  $url= preg_replace( '/\n/', "%0A", $url );    // keep line numbers for error messages
...
<<
HTTP/1.0 200 OK
Server: SmartMet Server (18:14:01 Sep 14 2010)
Content-Type: text/html; charset=ISO-8859-1
Content-Length: 243
Date: Thu, 18 Nov 2010 11:05:18 EET
Connection: Keep-Alive<<
*/
  $out= curl_exec( $ch );
  
  /* NOTE: Our regex is better. Handles both Windows based as well as Unix linefeeds.
  *
  * NOTE: This only keeps the last header line. Not that we actually use it for anything, though.
  */
