...
..8<...8<...8<...8<...8<...8<...8<...8<...8<...8<...8<...8<...8<...8<...
    ...
    SP_HttpMessage::void appendContent( const void * content, int length = 0,
int maxLength = 0 ); SP_HttpMessage::void setContent( const void * content, int
length = 0 ); SP_HttpMessage::const void * getContent() const;
...
public:
  ...
  /*virtual*/ void set_mime(const char *mime) {
  ...
  /*virtual*/ void append(const char *s, int bytes) {
    resp.appendContent(string(s, bytes));
  }
...
BS_RequestResponse::BS_RequestResponse(
    const SmartMet::Spine::HTTP::Request &req_,
    SmartMet::Spine::HTTP::Response &resp_)
    : req(req_), resp(resp_) {
...
Plugin::Plugin(SmartMet::Spine::Reactor *server, const char *cfg_file)
  ...
  //
  server->addContentHandler(this, "/q3",
                            boost::bind(&::native_handler, _1, _2, _3));
...
//
#ifdef ENABLE_OGC_WMS
  server->addContentHandler(this, "/q3_wms",
                            boost::bind(&::wms_handler, _1, _2, _3));
#endif
 ...
 */
extern "C" SmartMetPlugin *create(SmartMet::Spine::Reactor *them,
                                  const char *config) {
...
extern "C" void destroy(SmartMetPlugin *us) {
  // Seems we don't ever get here (at least the way 'systemctl stop smartmetd'
  // kills us)
  //
