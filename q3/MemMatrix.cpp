/*
 * MEMMATRIX.CPP                          Copyright (c) 2008-10, Ilmatieteen
 * laitos
 *
...
/*
 * Note: 'data' needs to be 16 byte aligned for SSE access. Traditional C++
 * 'new' does not provide alignment guarantees (at least not 16 bytes for an
 * array of floats).
 */
