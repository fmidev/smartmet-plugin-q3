...
# endif
  ...
  public:
    ...
    static void set_Decimals( lua_State *L, unsigned decs ) { set( L, REG_DECIMALS, decs ); }
...
# endif
#else
    static string_or_null get_Filename( lua_State *L ) { return get_str( L, REG_FILENAME ); }
    static void set_Filename( lua_State *L, const char *s ) { set( L, REG_FILENAME, s ); }
#endif
